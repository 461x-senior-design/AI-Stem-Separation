...
ERROR_UNSUPPORTED_FORMAT: str = "Unsupported file format: {format}. Supported formats are: {supported}."
...
ERROR_INVALID_SAMPLE_RATE: str = "Invalid sample rate: {sample_rate}Hz (range {min_rate}-{max_rate}Hz)"
ERROR_INVALID_CHANNELS: str = "Invalid channel count: {channels} (must be {min_channels}-{max_channels})"
