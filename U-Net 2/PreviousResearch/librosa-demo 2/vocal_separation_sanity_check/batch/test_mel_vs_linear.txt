...
parser.add_argument(
    ...
    choices=range(1, 19),
    metavar='N',
    help='Number of conv slices to test (1-18, default: 5)'
)
...
parser.add_argument(
    ...
    default='linear',
    choices=['linear', 'mel'],
    help='Spectrogram type: linear (STFT) or mel (default: linear)'
)

args = parser.parse_args()

print("="*70)
print(f"VOCAL SEPARATION TEST - {args.spec_type.upper()} SPECTROGRAM")
print("="*70)
print(f"\nSpectrogram type: {args.spec_type.upper()}")
print(f"Testing {args.slices} slices")
print()
